...
const Banner = () => {
    return (
        <div className="relative  bg-blue-200 h-[227px] lg:h-[400px]">
            <div className="max-w-5xl mx-auto">
                <img className="lg:h-[400px] lg:w-[500px] h-[227px] absolute inset-y-0 right-0" src={cover} alt="" />
                <div className=" pl-4 pt-8" data-aos="fade-right"
                    data-aos-easing="linear"
                    data-aos-duration="1500">
                    <h1 className="lg:text-7xl text-lg  font-extrabold text-blue-500">DIGITAL <br /> PRODUCT <br /> E-COMMERCE <br /> WEBSITE</h1>
