...
const UpdateCard = () => {
    ...
    const {_id, brand_name, name, type, price, rating, description,photo} = cards;
    ...
    const handleUpdateButton =(e) =>{
        ...
        const updateUser = {brand_name, name, type, price, rating, description,photo}
        
         console.log(updateUser)
         fetch(`https://e-commerce-project-server-smoky.vercel.app/updates/${_id}`,{
            method: 'PUT',
            headers :{
    ...
    return (
        <div>
             ...
             <div className="w-full">
                ...
                <input type="text" name="brand_name" defaultValue={brand_name} className="bg-gray-50 border  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="brand name" required />
             </div>
             </div>
